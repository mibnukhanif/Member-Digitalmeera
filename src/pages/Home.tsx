...
export default function Home() {
  return (
    <div className="space-y-12">
      <section className="text-center py-20 bg-gradient-to-b from-black to-zinc-900 text-white rounded-3xl shadow-2xl">
      ...
      <section className="grid md:grid-cols-3 gap-8">
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-zinc-100 text-center hover:shadow-md transition-shadow">
